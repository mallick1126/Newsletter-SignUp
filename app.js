...
//all the modules that we require for the project
...
// the get function toget the root file form our server.
...
app.post("/", function (req, res) {
  ...
  // this is the data format in which we are going to receive data form  our users and send to the mailchimp.
  var data = {
    members: [{
        email_address: email,
        status: "subscribed",
